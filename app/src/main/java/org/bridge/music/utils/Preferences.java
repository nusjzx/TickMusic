...
public class Preferences {
    ...
    public static boolean enableMobileNetworkPlay() {
        return getBoolean(sContext.getString(org.bridge.music.R.string.setting_key_mobile_network_play), false);
    }

    public static void saveMobileNetworkPlay(boolean enable) {
        saveBoolean(sContext.getString(org.bridge.music.R.string.setting_key_mobile_network_play), enable);
    }

    public static boolean enableMobileNetworkDownload() {
        return getBoolean(sContext.getString(org.bridge.music.R.string.setting_key_mobile_network_download), false);
    }
    ...
    public static String getFilterSize() {
        return getString(sContext.getString(org.bridge.music.R.string.setting_key_filter_size), "0");
    }

    public static void saveFilterSize(String value) {
        saveString(sContext.getString(org.bridge.music.R.string.setting_key_filter_size), value);
    }

    public static String getFilterTime() {
        return getString(sContext.getString(org.bridge.music.R.string.setting_key_filter_time), "0");
    }

    public static void saveFilterTime(String value) {
        saveString(sContext.getString(org.bridge.music.R.string.setting_key_filter_time), value);
    }
